...
class InputItem
{
    ...
    public function estimateBitStreamSizeOfEntry($version)
    {
        ...
        switch ($this->mode) {
            case QR_MODE_NUM:$bits = Input::estimateBitsModeNum($this->size);
                break;
            case QR_MODE_AN:$bits = Input::estimateBitsModeAn($this->size);
                break;
            case QR_MODE_8:$bits = Input::estimateBitsMode8($this->size);
                break;
            case QR_MODE_KANJI:$bits = Input::estimateBitsModeKanji($this->size);
                break;
